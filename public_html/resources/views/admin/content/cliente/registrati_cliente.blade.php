                ...
                <div class="contact__form">
                    <form method="post" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" required value="" name="PartitaIva" placeholder="PartitaIva">
                            </div>
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-12">
                                <button type="submit" name="registrazione" value="Invia Registrazione"
                                        style="width: 100%"
                                        class="site-btn">Invia Registrazione
                                </button>
                            </div>
                        </div>
                    </form>
...
<script type="text/javascript">
    ...
    titleTag.setAttribute("content", "GTRIMPORT - Registrazione per diventare nostro cliente");

    descriptionTag = document.createElement('META');
    descriptionTag.setAttribute("name", "description");
    descriptionTag.setAttribute("content", "GTR IMPORT - Registrazione al Portale Clienti: Accedi a un'Esclusiva Area Personale per diventare un nostro cliente e sfruttare appieno le nostra attivitá.");

    keywordsTag = document.createElement('META');
    keywordsTag.setAttribute("name", "keywords");
    keywordsTag.setAttribute("content", "GTRIMPORT,registrazione,Portale cliente,Gestione,ordini,Monitoraggio,dati,Account,servizi");

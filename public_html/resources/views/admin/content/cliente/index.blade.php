...
<section class="product spad">
    ...
    <div class="container">
        ...
        <div class="row product__filter">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix <?php echo DB::SELECT('SELECT REPLACE(GROUP_CONCAT(descrizione),\',\',\' \') as desc_ from arattributo where id_ditta = 5 and id_attributo IN ('.$a->attributi.')')[0]->desc_; ?> zoom">
                <form method="post">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" style="background-size:contain!important"
                             data-setbg="<?php echo URL::ASSET($a->copertina)?>">
...
" style="background-color:white;border:none"></i></button>
                            <input type="number" id="quantita_<?php echo $a->id ?>"
                                   ...
                                   class="add-cart"
                                   value="<?php echo ($a->disponibile > $a->xqtaconf) ? ($a->xqtaconf != '0.00') ? intval($a->xqtaconf) : '1' : '0' ?>"
                            ...
                            <button type="button" style="border:none;background: transparent"
                                    ...
                                    id="aumenta_<?php echo $a->id ?>" class="add-cart"><i
                                        ...
                                        style="background-color:white;border:none"> </i></button>
                            <button type="button" style="border:none;background: transparent"
                                    onclick="<?php echo (!session()->has('utente')) ?    "javascript:location.href='".URL::ASSET('cliente/login')."'": 'aggiungi(\''.$a->id.'\')' ?>"
                                ...
                                <?php /*
                            <h6><?php echo $a->descrizione ?></h6>
                            <input type="hidden" value="<?php echo $a->id ?>" name="id_prodotto" id="id_prodotto">
                            <input type="hidden" value="1" name="quantita" id="quantita">
                            <input type="hidden" value="" name="sconto" id="sconto">
                            <button type="submit" style="visibility: hidden!important;top: 22px!important;" value="<?php echo ($a->xqtaconf != '0.00')?intval($a->xqtaconf):'1'?>" name="aggiungi_al_carrello" id="aggiungi_al_carrello">
                            ...
                            <h5><?php if(sizeof($prezzo) > 0 )echo number_format($prezzo[0]->prezzo,'2').'€'; ?></h5><?php }?>
